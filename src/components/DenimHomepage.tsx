    ...
    <main>
      <section className="flex flex-col items-center w-full max-md:max-w-full">
        <ImageHero
          ...
          buttonText="Shop Now"
          buttonLink="#"
          backgroundImage="https://cdn.builder.io/api/v1/image/assets/63f2ce2bdfab4e1fa0343b7d8a43d1d9/d3975d372883951433957e5d052146777db8f5349154b3af9eb18074885496ba?placeholderIfAbsent=true"
          alignment="right"
        />
      </section>
      ...
      <section className="flex flex-col items-center mt-24 w-full max-md:mt-10 max-md:max-w-full">
        ...
        <SplitHero
          ...
          image="https://cdn.builder.io/api/v1/image/assets/63f2ce2bdfab4e1fa0343b7d8a43d1d9/539b4f8a1dc54a9c6c0e64c7ab487c9ef0bdc85f02e5c8f4eb576a3124d4479a?placeholderIfAbsent=true"
