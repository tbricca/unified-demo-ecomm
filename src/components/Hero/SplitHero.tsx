...
interface SplitHeroProps {
  ...
  shrinkImage: 'shrink' | 'crop';
}

const SplitHero: React.FC<SplitHeroProps> = ({ imageAlignment, splitWidth, textAlignment, title, subTitle, image, altText, hasCTA, buttonText, buttonLink, makeFullBleed, shrinkImage }) => {
  ...
  const imageShrink = shrinkImage === 'crop' ? "object-cover w-full aspect-[0.92] rounded-md" : "object-contain w-full h-auto max-w-full rounded-md";
